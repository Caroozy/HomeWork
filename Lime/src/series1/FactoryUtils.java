...
public class FactoryUtils {
    ...
    public static List<Employee> initEmployees() {
        ...
        for (int i=0;i<2;i++){
            ...
            employeeList.add(new Manager(Name.getRandomName(),randSalary(12000,15500),"Truth Distribution"));
            employeeList.add(new Engineer(Name.getRandomName(),randSalary(9000,11000),"Conspiracy"));
            employeeList.add(new Employee(Name.getRandomName(),randSalary(7000,35000)));
        }
        employeeList.add(new Employee(Name.getRandomName(),randSalary(7000,35000)));
        employeeList.add(new Director(Name.getRandomName(),randSalary(18000,35000),"Networking","VIP"));
        return employeeList;
    }
}
